...
class RockPaperScissors {
  ...
  evaluate(func) {
    ...
    try {
      const result1 = func(0);
      const expected1 = [''];
      const result2 = func(1);
      const expected2 = ['r', 'p', 's'];
      const result3 = func(2);
      const expected3 = ['rr', 'rp', 'rs', 'pr', 'pp', 'ps', 'sr', 'sp', 'ss'];
      const result4 = func(3);
      const expected4 = ['rrr', 'rrp', 'rrs', 'rpr', 'rpp', 'rps', 'rsr', 'rsp', 'rss', 'prr', 'prp', 'prs', 'ppr', 'ppp', 'pps', 'psr', 'psp', 'pss', 'srr', 'srp', 'srs', 'spr', 'spp', 'sps', 'ssr', 'ssp', 'sss'];
